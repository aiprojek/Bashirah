        ...
        <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden flex flex-col transform transition-all scale-100 border border-white/10">
            ...
            <div className="p-6 space-y-6">
                ...
                <div>
                    <div className="flex justify-between items-center mb-3">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider flex items-center gap-2">
                            <span className="bg-quran-gold/10 p-1 rounded text-quran-dark"><Type className="w-3 h-3" /></span>
                            Ukuran Arab
                        </label>
                        <span className="text-xs font-bold text-quran-gold bg-stone-50 border border-stone-100 px-2 py-0.5 rounded">{arabicFontSize}px</span>
                    </div>
                    
                    <div className="flex items-center gap-3">
                        <CaseUpper className="w-4 h-4 text-gray-300" />
                        <input 
                            type="range" 
                            min="20" 
                            max="60" 
                        ...
                        />
                        <CaseUpper className="w-6 h-6 text-quran-dark" />
                    </div>

                    {/* Live Preview */}
                    <div className="mt-4 p-4 bg-[#fcfbf7] rounded-xl border border-stone-100 text-right shadow-inner">
                        <p className="font-arabic text-quran-dark leading-loose transition-all duration-200" style={{ fontSize: `${arabicFontSize}px` }} dir="rtl">
                ...
                <div>
                    <div className="flex justify-between items-center mb-3">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider flex items-center gap-2">
                             <span className="bg-stone-100 p-1 rounded text-gray-500"><Type className="w-3 h-3" /></span>
                             Ukuran Terjemahan
                        </label>
                        <span className="text-xs font-bold text-quran-gold bg-stone-50 border border-stone-100 px-2 py-0.5 rounded">{translationFontSize}px</span>
                    </div>
                    
                    <div className="flex items-center gap-3">
                        <CaseUpper className="w-3 h-3 text-gray-300" />
                        <input 
                            type="range" 
                            min="12" 
                            max="24" 
                            ...
                            className="w-full h-2 bg-stone-200 rounded-lg appearance-none cursor-pointer accent-quran-gold"
                        />
                        <CaseUpper className="w-5 h-5 text-gray-600" />
                    </div>

                     {/* Live Preview */}
                     <div className="mt-4 p-4 bg-stone-50 rounded-xl border border-stone-100 text-left shadow-inner">
                        <p className="text-gray-600 font-serif italic leading-relaxed transition-all duration-200" style={{ fontSize: `${translationFontSize}px` }}>
