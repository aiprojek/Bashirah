...
import { Share2, Loader2, X, Quote } from 'lucide-react';
...
const ShareVerseModal: React.FC<ShareVerseModalProps> = ({ 
    ...
    const handleShare = async () => {
        ...
        try {
            // We capture the HIDDEN export card
            const canvas = await html2canvas(exportRef.current, {
                ...
                logging: false,
                windowWidth: 1080,
                windowHeight: 1080, // Force square calculation
            });
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 animate-fade-in">
            ...
            <div className="relative w-full max-w-sm z-10 flex flex-col items-center">
                ...
                <div className="w-full flex flex-col gap-4">
                    ...
                    <div 
                        className="relative aspect-square w-full overflow-hidden rounded-3xl bg-gradient-to-br from-[#1e3a34] to-[#0f2420] text-white shadow-2xl border border-white/10 flex flex-col justify-between p-6"
                    >
                        {/* Decorative Elements */}
                    ...
                    <button 
                        ...
                        className="w-full bg-quran-gold hover:bg-yellow-500 text-white py-3.5 rounded-xl font-bold text-sm shadow-lg transition-all flex items-center justify-center gap-2 whitespace-nowrap"
                    >
