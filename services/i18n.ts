...
type TranslationKey = 
  ...
  | 'nav_about' | 'nav_mutashabihat' | 'app_title' | 'app_subtitle'
  // Home
  | 'home_greeting' | 'home_subtitle' | 'search_placeholder' | 'daily_verse'
  | 'last_read' | 'khatam_target' | 'tab_surah' | 'tab_juz' | 'tab_page' | 'tab_manzil'
  | 'manzil_title' | 'manzil_desc'
  | 'mutashabihat_title' | 'mutashabihat_desc' | 'mutashabihat_phrases_tab' | 'mutashabihat_structural_tab'
  | 'no_surah_found'
  ...
  | 'settings_autosave_last_read' | 'settings_autosave_last_read_desc' 
  ...
  | 'feature_ayah_topics_title' | 'feature_ayah_topics_desc'
  | 'feature_mutashabihat_title' | 'feature_mutashabihat_desc'
  | 'feature_verse_action_title' | 'feature_verse_action_desc'
  | 'feature_back_to_top_title' | 'feature_back_to_top_desc'
  // Loading & Nav
  | 'loading_title' | 'loading_desc'
  | 'prev_surah' | 'next_surah'
  // Pages Titles & Descs
  | 'topics_title' | 'topics_desc' | 'topics_ref' | 'topics_collection'
  | 'topics_tab_featured' | 'topics_tab_all' | 'topics_search_placeholder'
  | 'topics_filter_all' | 'topics_filter_popular' | 'topics_filter_prophets' | 'topics_filter_theology' | 'topics_filter_worship' | 'topics_filter_creation'
  | 'topics_sort_most' | 'topics_sort_az' | 'topics_verses_count' | 'topics_empty' | 'topics_load_more' | 'topics_search_ayah' | 'topics_showing_results'
...
const translations: Record<LanguageCode, Record<string, string>> = {
  id: {
    ...
    tab_page: "Halaman",
    tab_manzil: "Manzil",
    manzil_title: "Manzil (Khatam 7 Hari)",
    manzil_desc: "Pembagian 7 Manzil Al-Qur'an (Fami bi-Shawq) untuk mengkhatamkan Al-Qur'an dalam satu pekan.",
    mutashabihat_title: "Mutasyabihat & Frasa Berulang",
    mutashabihat_desc: "Eksplorasi lafadz dan frasa yang berulang antar surat untuk memperkuat hafalan Al-Qur'an.",
    mutashabihat_phrases_tab: "Frasa Berulang",
    mutashabihat_structural_tab: "Struktur Ayat",
    ...
    settings_autosave_last_read: "Auto-Save Ayat Terakhir",
    settings_autosave_last_read_desc: "Simpan otomatis hingga 3 ayat terakhir yang sedang dibaca saat scroll atau mendengarkan audio (Default nonaktif).",
    ...
    about_info_badge: "Informasi",
    about_hero_title: "Tentang Bashirah",
    about_hero_desc: "Mengenal lebih dekat aplikasi Bashirah, fitur-fitur unggulan, serta terhubung dengan komunitas dan pembuat.",
    ...
    feature_ayah_topics_title: "Tema & Topik Ayat", feature_ayah_topics_desc: "Eksplorasi tema pokok dan topik bahasan tematik Al-Qur'an per ayat dengan tautan komprehensif.",
    feature_mushaf_structure_title: "Navigasi Juz, Halaman, Manzil, Hizb & Ruku'", feature_mushaf_structure_desc: "Jelajahi Al-Qur'an secara presisi melalui pembagian 30 Juz, 604 Halaman Rasm Utsmani, 7 Manzil, 60 Hizb, dan penanda Ruku'.",
    feature_sajdah_title: "Ayat Sajdah & Sujud Tilawah", feature_sajdah_desc: "Indikator visual khusus pada 15 ayat sajdah disertai panduan doa dan anjuran sujud tilawah.",
    feature_dua_dhikr_title: "Koleksi Doa & Dzikir Harian", feature_dua_dhikr_desc: "Kumpulan doa mustajab para Nabi dari Al-Qur'an, Dzikir Pagi & Petang, serta Asmaul Husna.",
    feature_tajweed_learn_title: "Modul & Kuis Belajar Tajwid", feature_tajweed_learn_desc: "Pelajari hukum tajwid (Nun Sukun, Mim Sukun, Mad, Qalqalah) lengkap dengan audio dan kuis interaktif.",
    feature_heatmap_title: "Riwayat Tilawah & Heatmap Istiqamah", feature_heatmap_desc: "Visualisasi kalender kontribusi tilawah di Pustaka Saya untuk memantau konsistensi ibadah tanpa riya'.",
    feature_mutashabihat_title: "Mutasyabihat & Ayat Serupa", feature_mutashabihat_desc: "Deteksi kemiripan redaksi dan lafadz ayat antar surat untuk menguatkan hafalan dan tadabbur.",
    feature_verse_action_title: "Wawasan Ayat Mode Mushaf", feature_verse_action_desc: "Akses cepat tafsir offline/online, salin ayat, audio, dan penanda ayat saat membaca Mushaf.",
    feature_back_to_top_title: "Tombol Kembali ke Atas", feature_back_to_top_desc: "Tombol melayang pintar (auto-hide) untuk kembali ke puncak halaman dengan satu ketukan halus.",
    ...
    topics_tab_featured: "Tema Pilihan",
    topics_tab_all: "Semua Topik",
    topics_search_placeholder: "Cari topik Al-Quran (misal: Musa, Sabar, Surga)...",
    topics_filter_all: "Semua",
    topics_filter_popular: "Paling Populer",
    topics_filter_prophets: "Nabi & Tokoh",
    topics_filter_theology: "Akidah & Gaib",
    topics_filter_worship: "Ibadah & Akhlak",
    topics_filter_creation: "Alam & Ciptaan",
    topics_sort_most: "Paling Banyak Ayat",
    topics_sort_az: "Nama A-Z",
    topics_verses_count: "Ayat",
    topics_empty: "Tidak ditemukan topik yang sesuai dengan pencarian Anda.",
    topics_load_more: "Tampilkan Lebih Banyak Topik",
    topics_search_ayah: "Cari ayat atau nama surah dalam topik ini...",
    topics_showing_results: "Menampilkan {count} topik",
    ...
    topic_tauhid_title: "Tauhid & Kebesaran Allah", topic_tauhid_desc: "Ayat-ayat tentang keesaan Allah, sifat-sifat-Nya, dan kemurnian aqidah.",
    topic_hari_akhir_title: "Hari Akhir & Kiamat", topic_hari_akhir_desc: "Pengingat tentang hari kebangkitan, hisab amalan, surga, dan neraka.",
    topic_taubat_title: "Taubat & Ampunan", topic_taubat_desc: "Pintu ampunan Allah yang luas, keutamaan istighfar, dan pembersihan jiwa.",
    topic_syukur_title: "Syukur & Nikmat", topic_syukur_desc: "Perintah bersyukur atas karunia Allah dan janji bertambahnya nikmat.",
    topic_kisah_nabi_title: "Kisah Para Nabi", topic_kisah_nabi_desc: "Pelajaran dan teladan dari perjuangan serta doa para utusan Allah.",
    topic_keadilan_title: "Keadilan & Kejujuran", topic_keadilan_desc: "Perintah menegakkan keadilan, kejujuran dalam timbangan, dan anti kecurangan.",
    topic_alam_title: "Alam Semesta & Penciptaan", topic_alam_desc: "Tanda-tanda kebesaran Allah di langit, bumi, dan rahasia penciptaan makhluk.",
    topic_persaudaraan_title: "Ukhuwah & Perdamaian", topic_persaudaraan_desc: "Menjaga persatuan umat, mendamaikan perselisihan, dan saling menghormati.",
    ...
    menu: "Menu",
    options: "Opsi",
    modal_select_lang: "Pilih Bahasa",
    modal_select_reciter: "Pilih Qari",
    audio_download_and_play: "Unduh & Putar",
    audio_save_offline: "Simpan Offline",
    quick_jump: "Pindah Cepat",
    surah_list: "Daftar Surat",
    quick_jump_select_surah: "Pilih Surat",
    quick_jump_select_verse: "Pilih Ayat",

    // Settings
    settings_center: "Pusat Pengaturan",
    settings_quick: "Pengaturan Cepat",
    settings_tab_quick: "Cepat",
    settings_tab_display: "Tampilan",
    settings_tab_reading: "Bacaan",
    settings_tab_audio: "Audio",
    settings_tab_offline: "Offline",
    settings_tab_about: "Tentang",
    settings_status_active_ready: "Aktif (Offline Siap)",
    settings_status_selected_download: "Dipilih (Perlu Unduh)",
    settings_status_saved: "Tersimpan",
    settings_not_downloaded: "Belum diunduh untuk offline",
    settings_download_offline: "Unduh Offline",
    settings_delete_offline_data: "Hapus data offline",
    settings_mushaf_image_req: "Mushaf Gambar (Perlu Unduh)",
    settings_download_this_mushaf: "Unduh Data Mushaf Ini",
    settings_backup_desc: "Simpan cadangan data penting agar catatan, bookmark, dan pengaturan tetap aman.",
    settings_pack_installed: "Sudah Terpasang",
    settings_pack_download: "Unduh Pack",
    settings_pack_not_downloaded: "Belum diunduh.",
    settings_pending_downloads: "Unduhan Tertunda",
    settings_no_pending_downloads: "Tidak ada unduhan tertunda.",
    settings_ready_badge: "Siap",
    settings_active_qari: "Qari aktif",
    settings_surahs_ready: "surat siap",
    settings_on: "Menyala",
    settings_off: "Mati",
    settings_not_enabled: "Belum diaktifkan",
    ...
    mushaf_prev_page: "Halaman Sebelumnya",
    mushaf_next_page: "Halaman Berikutnya",
    mushaf_btn_list: "Daftar",
    mushaf_btn_text: "Teks",
    mushaf_btn_mark: "Tandai",
    mushaf_btn_mark_done: "Tandai Selesai Dibaca",
    mushaf_last_read_page: "Halaman Terakhir Dibaca",
    mushaf_fullscreen: "Layar Penuh",
    mushaf_reset_zoom: "Reset Zoom",
    mushaf_page_trans: "Terjemahan Halaman",
    mushaf_failed_image: "Gagal memuat gambar.",
    mushaf_copy_page_verses: "Salin Ayat Halaman",
    mushaf_murottal_page: "Murottal Per Halaman",

    // Verse Actions
    verse_play_this: "Putar Ayat Ini",
    verse_options: "Opsi Ayat",
    verse_update_khatam: "Update Progres Khatam",
    verse_mark_last_read: "Tandai Terakhir Dibaca",
    verse_copy: "Salin Ayat",
    verse_copied: "Tersalin",
    verse_share_img: "Bagikan Gambar",
    verse_del_bookmark: "Hapus Bookmark",
    verse_add_bookmark: "Bookmark",
    verse_edit_note: "Ubah Catatan",
    verse_create_note: "Buat Catatan",
    verse_tap_reveal: "Ketuk untuk melihat",
    verse_now_playing: "Sedang Diputar",
    verse_tafsir: "Tafsir",
    verse_word_detail: "Lihat detail kata",

    // Grammar & Morphology
    grammar_modal_title: "Grammar & Morfologi",
    grammar_loading: "Memuat data grammar...",
    grammar_root: "Akar Kata",
    grammar_lemma: "Lemma",
    grammar_stem: "Stem",
    grammar_ayah_morph: "Morfologi Ayat Ini",
    grammar_ayah_root: "Akar Kata Ayat",
    grammar_ayah_lemma: "Lemma Ayat",
    grammar_ayah_stem: "Stem Ayat",
    grammar_explore: "Jelajahi Al-Quran",
    grammar_explore_desc: "Temukan di ayat mana saja kata ini (atau kata dasarnya) disebutkan dalam Al-Quran.",
    grammar_search_btn: "Cari Kata Ini",
    grammar_search_results: "Hasil Pencarian",
    grammar_verses_found: "Ayat Ditemukan",
    grammar_scanning: "Sedang memindai seluruh Al-Quran...",
    grammar_open_verse: "Buka",
    grammar_no_results: "Tidak ada ayat lain yang ditemukan.",
    grammar_unavailable: "Data grammar offline belum tersedia untuk kata ini. Bashirah sudah siap menampilkannya setelah pack QUL morphology ditambahkan.",
    ...
    page_prev: "Halaman Sebelumnya",
    page_next: "Halaman Selanjutnya",

    // Mushaf Text & Actions
    mushaf_download_translation_offline: "Terjemahan offline belum diunduh",
    mushaf_page_text_copied: "Teks ayat halaman berhasil disalin",
    mushaf_nav_info: "Info Navigasi Ayat",
    mushaf_page_actions: "Aksi Halaman",
    mushaf_page_murottal: "Murottal Per Halaman",
    mushaf_khatam_progress: "Progres Khatam",
    mushaf_mark_page_read: "Tandai Halaman Dibaca",
    mushaf_image_btn: "Gambar",
    mushaf_list_mode: "Tampilan Daftar",
    mushaf_list_btn: "Daftar",
    mushaf_offline_ready: "Siap Offline",

    // Verse Actions
    verse_action_tafsir: "Lihat Tafsir",
    verse_action_copy: "Salin Ayat",
    verse_action_share: "Bagikan Gambar",

    // Word Detail & Grammar
    word_detail_grammar_title: "Grammar & Morfologi",
    word_detail_grammar_loading: "Memuat data morfologi & grammar...",
    word_detail_part_of_speech: "Kelas Kata (POS)",
    word_detail_grammar: "Bentuk Tata Bahasa",
    word_detail_root: "Akar Kata (Root)",
    word_detail_lemma: "Lemma (Dasar)",
    word_detail_stem: "Stem (Batang)",
    word_detail_ayah_morphology: "Morfologi Ayat Ini",
    word_detail_ayah_root: "Akar Kata Ayat",
    word_detail_ayah_lemma: "Lemma Ayat",
    word_detail_ayah_stem: "Stem Ayat",
    word_detail_no_grammar: "Data tata bahasa offline belum tersedia untuk kata ini.",
    word_detail_explore_title: "Jelajahi Al-Quran",
    word_detail_explore_desc: "Temukan di ayat mana saja kata ini (atau kata dasarnya) disebutkan dalam Al-Quran.",
    word_detail_search_btn: "Cari Kata Ini",
    word_detail_search_results: "Hasil Pencarian",
    word_detail_verses_found: "Ayat Ditemukan",
    word_detail_scanning: "Sedang memindai seluruh Al-Quran...",
    word_detail_open: "Buka",
    word_detail_showing_first_50: "Menampilkan 50 kemunculan pertama.",
    word_detail_no_verses: "Tidak ada ayat lain yang ditemukan.",
    word_detail_context_title: "Konteks Kalimat / Ayat",
    word_detail_word_badge: "Detail Kata",
    word_detail_sentence_badge: "Kalimat Ayat",
    word_detail_loading_sentence: "Memuat konteks kalimat...",
    word_detail_ayah_trans_title: "Terjemahan Ayat",
    pos_noun: "Isim (Kata Benda)",
    pos_verb: "Fi'il (Kata Kerja)",
    pos_particle: "Huruf / Harf",
    pos_pronoun: "Dhamir (Kata Ganti)",
    pos_adjective: "Sifat (Kata Sifat)",
    pos_adverb: "Zharaf (Keterangan)",
    pos_proper_noun: "Isim Alam (Nama Diri)",
    grammar_base_form: "Morfologi Kata Dasar",

    // Additional Settings Translations
    settings_additional_assets: "Aset Offline Tambahan",
    settings_additional_assets_desc: "Tambahkan info surat dan analisis kata agar fitur bacaan offline terasa lebih lengkap.",
    settings_word_analysis: "Analisis Kata Quran",
    settings_word_analysis_desc: "Membantu memahami kata dan susunan ayat saat kamu mengetuk kata Arab, termasuk bentuk dasar dan keterkaitannya dalam ayat.",
    settings_surah_info_offline: "Info Surat & Asbabun Nuzul Offline",
    settings_surah_info_offline_desc: "Menyediakan penjelasan surat, latar turunnya, dan pokok kandungannya agar tetap bisa dibaca tanpa internet.",
    settings_default_mushaf_mode: "Default Mode Mushaf",
    settings_mushaf_not_downloaded: "Belum diunduh untuk tampilan gambar offline",
    settings_tab_mushaf: "Mushaf",
    settings_active_reciter: "Qari aktif",
    settings_mushaf_ready: "jenis siap",
    theme_light_btn: "Terang",
    theme_dark_btn: "Gelap",
    theme_system_btn: "Sistem"
  },
  en: {
    nav_home: "Home",
    ...
    tab_page: "Page",
    tab_manzil: "Manzil",
    manzil_title: "Manzil (7-Day Completion)",
    manzil_desc: "Division of 7 Quran Manzils (Fami bi-Shawq) to complete the entire Quran in one week.",
    mutashabihat_title: "Mutashabihat & Recurring Phrases",
    mutashabihat_desc: "Explore recurring phrases and identical wording across surahs to strengthen memorization.",
    mutashabihat_phrases_tab: "Recurring Phrases",
    mutashabihat_structural_tab: "Verse Similarity",
    ...
    settings_autosave_last_read: "Auto-Save Last Read",
    settings_autosave_last_read_desc: "Automatically save up to 3 recent verses while reading or listening to audio (Disabled by default).",
    ...
    about_info_badge: "Information",
    about_hero_title: "About Bashirah",
    about_hero_desc: "Get to know the Bashirah application, key features, and connect with the community and developers.",
    ...
    feature_ayah_topics_title: "Ayah Themes & Topics", feature_ayah_topics_desc: "Explore the core theme and comprehensive Quranic topics embedded in each individual ayah.",
    feature_mushaf_structure_title: "Juz, Page, Manzil, Hizb & Ruku' Navigation", feature_mushaf_structure_desc: "Navigate the Quran precisely across 30 Juz, 604 Uthmani Pages, 7 Manzil, 60 Hizb, and Ruku' division markers.",
    feature_sajdah_title: "Sajdah Verses & Tilawah Prostration", feature_sajdah_desc: "Visual indicators on 15 sajdah verses with supplication guide and recommendations for Sujud Tilawah.",
    feature_dua_dhikr_title: "Daily Dua & Dhikr Collection", feature_dua_dhikr_desc: "Compilation of prophetic supplications from the Quran, Morning & Evening Dhikr, and Asmaul Husna.",
    feature_tajweed_learn_title: "Tajweed Learning & Quiz Modules", feature_tajweed_learn_desc: "Master tajweed rules (Nun/Mim Sukun, Mad, Qalqalah) with audio examples and interactive quizzes.",
    feature_heatmap_title: "Reading Heatmap & Tilawah Tracker", feature_heatmap_desc: "Visual contribution activity calendar in My Library to track daily reading consistency and habit.",
    feature_mutashabihat_title: "Mutashabihat & Similar Ayahs", feature_mutashabihat_desc: "Detect lexical similarities and matching phrases across surahs to reinforce memorization.",
    feature_verse_action_title: "Mushaf Ayah Insights", feature_verse_action_desc: "Quick access to offline/online tafsir, copy verse, audio, and bookmarking while reading Mushaf.",
    feature_back_to_top_title: "Back to Top Navigation", feature_back_to_top_desc: "Smart auto-hiding floating button to smoothly scroll back to the top of long pages.",
    ...
    topics_tab_featured: "Featured Themes",
    topics_tab_all: "All Topics",
    topics_search_placeholder: "Search Quranic topics (e.g., Moses, Patience, Paradise)...",
    topics_filter_all: "All",
    topics_filter_popular: "Most Popular",
    topics_filter_prophets: "Prophets & Figures",
    topics_filter_theology: "Faith & Unseen",
    topics_filter_worship: "Worship & Virtues",
    topics_filter_creation: "Nature & Creation",
    topics_sort_most: "Most Verses",
    topics_sort_az: "Name A-Z",
    topics_verses_count: "Verses",
    topics_empty: "No topics found matching your search.",
    topics_load_more: "Load More Topics",
    topics_search_ayah: "Search verses or surah in this topic...",
    topics_showing_results: "Showing {count} topics",
    ...
    topic_tauhid_title: "Tawheed & Oneness of Allah", topic_tauhid_desc: "Verses on the oneness of Allah, His divine attributes, and purity of faith.",
    topic_hari_akhir_title: "The Hereafter & Day of Judgment", topic_hari_akhir_desc: "Reminders of resurrection, reckoning of deeds, Paradise, and Hellfire.",
    topic_taubat_title: "Repentance & Forgiveness", topic_taubat_desc: "Allah's vast mercy and forgiveness, seeking pardon, and cleansing of sins.",
    topic_syukur_title: "Gratitude & Blessings", topic_syukur_desc: "Commands to be grateful for Allah's favors and the promise of multiplied blessings.",
    topic_kisah_nabi_title: "Stories of the Prophets", topic_kisah_nabi_desc: "Lessons and exemplary guidance from the journeys and prayers of Allah's messengers.",
    topic_keadilan_title: "Justice & Honesty", topic_keadilan_desc: "Directives to uphold justice, fairness in measure, and avoid wrongdoing.",
    topic_alam_title: "Universe & Creation", topic_alam_desc: "Signs of Allah's magnificence in the heavens, earth, and secrets of creation.",
    topic_persaudaraan_title: "Brotherhood & Peace", topic_persaudaraan_desc: "Preserving unity of believers, resolving disputes, and fostering mutual respect.",
    ...
    menu: "Menu",
    options: "Options",
    modal_select_lang: "Select Language",
    modal_select_reciter: "Select Reciter",
    audio_download_and_play: "Download & Play",
    audio_save_offline: "Save Offline",
    quick_jump: "Quick Jump",
    surah_list: "Surah List",
    quick_jump_select_surah: "Select Surah",
    quick_jump_select_verse: "Select Verse",

    // Settings
    settings_center: "Settings Center",
    settings_quick: "Quick Settings",
    settings_tab_quick: "Quick",
    settings_tab_display: "Display",
    settings_tab_reading: "Reading",
    settings_tab_audio: "Audio",
    settings_tab_offline: "Offline",
    settings_tab_about: "About",
    settings_status_active_ready: "Active (Offline Ready)",
    settings_status_selected_download: "Selected (Download Required)",
    settings_status_saved: "Saved",
    settings_not_downloaded: "Not downloaded for offline",
    settings_download_offline: "Download Offline",
    settings_delete_offline_data: "Delete offline data",
    settings_mushaf_image_req: "Image Mushaf (Download Required)",
    settings_download_this_mushaf: "Download This Mushaf Data",
    settings_backup_desc: "Save a backup of important data to keep notes, bookmarks, and settings safe.",
    settings_pack_installed: "Installed",
    settings_pack_download: "Download Pack",
    settings_pack_not_downloaded: "Not downloaded.",
    settings_pending_downloads: "Pending Downloads",
    settings_no_pending_downloads: "No pending downloads.",
    settings_ready_badge: "Ready",
    settings_active_qari: "Active reciter",
    settings_surahs_ready: "surahs ready",
    settings_on: "On",
    settings_off: "Off",
    settings_not_enabled: "Disabled",
    ...
    mushaf_btn_list: "List",
    mushaf_btn_text: "Text",
    mushaf_btn_mark: "Mark",
    mushaf_btn_mark_done: "Mark as Completed",
    mushaf_last_read_page: "Last Read Page",
    mushaf_fullscreen: "Fullscreen",
    mushaf_reset_zoom: "Reset Zoom",
    mushaf_page_trans: "Page Translation",
    mushaf_failed_image: "Failed to load image.",
    mushaf_copy_page_verses: "Copy Page Verses",
    mushaf_murottal_page: "Page Audio Murottal",

    // Verse Actions
    verse_play_this: "Play This Verse",
    verse_options: "Verse Options",
    verse_update_khatam: "Update Khatam Progress",
    verse_mark_last_read: "Mark as Last Read",
    verse_copy: "Copy Verse",
    verse_copied: "Copied",
    verse_share_img: "Share Image",
    verse_del_bookmark: "Remove Bookmark",
    verse_add_bookmark: "Bookmark",
    verse_edit_note: "Edit Note",
    verse_create_note: "Add Note",
    verse_tap_reveal: "Tap to reveal",
    verse_now_playing: "Now Playing",
    verse_tafsir: "Tafsir",
    verse_word_detail: "View word details",

    // Grammar & Morphology
    grammar_modal_title: "Grammar & Morphology",
    grammar_loading: "Loading grammar data...",
    grammar_root: "Root Word",
    grammar_lemma: "Lemma",
    grammar_stem: "Stem",
    grammar_ayah_morph: "Ayah Morphology",
    grammar_ayah_root: "Ayah Root",
    grammar_ayah_lemma: "Ayah Lemma",
    grammar_ayah_stem: "Ayah Stem",
    grammar_explore: "Explore Quran",
    grammar_explore_desc: "Discover in which verses this word (or its root) is mentioned in the Quran.",
    grammar_search_btn: "Search This Word",
    grammar_search_results: "Search Results",
    grammar_verses_found: "Verses Found",
    grammar_scanning: "Scanning the entire Quran...",
    grammar_open_verse: "Open",
    grammar_no_results: "No other verses found.",
    grammar_unavailable: "Offline grammar data is not yet available for this word. Bashirah is ready to display it once the QUL morphology pack is added.",
    ...
    // Mushaf Text & Actions
    mushaf_download_translation_offline: "Offline translation not yet downloaded",
    mushaf_page_text_copied: "Page verse text copied successfully",
    mushaf_nav_info: "Verse Navigation Info",
    mushaf_page_actions: "Page Actions",
    mushaf_page_murottal: "Page Audio Murottal",
    mushaf_khatam_progress: "Khatam Progress",
    mushaf_mark_page_read: "Mark Page as Read",
    mushaf_image_btn: "Image",
    mushaf_list_mode: "List View",
    mushaf_list_btn: "List",
    mushaf_offline_ready: "Offline Ready",

    // Verse Actions
    verse_action_tafsir: "View Tafsir",
    verse_action_copy: "Copy Verse",
    verse_action_share: "Share Image",

    // Word Detail & Grammar
    word_detail_grammar_title: "Grammar & Morphology",
    word_detail_grammar_loading: "Loading morphology & grammar data...",
    word_detail_part_of_speech: "Part of Speech (POS)",
    word_detail_grammar: "Grammar Form",
    word_detail_root: "Root Word",
    word_detail_lemma: "Lemma",
    word_detail_stem: "Stem",
    word_detail_ayah_morphology: "Ayah Morphology",
    word_detail_ayah_root: "Ayah Root",
    word_detail_ayah_lemma: "Ayah Lemma",
    word_detail_ayah_stem: "Ayah Stem",
    word_detail_no_grammar: "Offline grammar data is not yet available for this word.",
    word_detail_explore_title: "Explore Quran",
    word_detail_explore_desc: "Discover in which verses this word (or its root) is mentioned in the Quran.",
    word_detail_search_btn: "Search This Word",
    word_detail_search_results: "Search Results",
    word_detail_verses_found: "Verses Found",
    word_detail_scanning: "Scanning the entire Quran...",
    word_detail_open: "Open",
    word_detail_showing_first_50: "Showing the first 50 occurrences.",
    word_detail_no_verses: "No other verses found.",
    word_detail_context_title: "Sentence & Verse Context",
    word_detail_word_badge: "Word Detail",
    word_detail_sentence_badge: "Verse Sentence",
    word_detail_loading_sentence: "Loading verse context...",
    word_detail_ayah_trans_title: "Verse Translation",
    pos_noun: "Noun (Isim)",
    pos_verb: "Verb (Fi'il)",
    pos_particle: "Particle / Harf",
    pos_pronoun: "Pronoun (Dhamir)",
    pos_adjective: "Adjective (Sifat)",
    pos_adverb: "Adverb (Zharaf)",
    pos_proper_noun: "Proper Noun (Isim Alam)",
    grammar_base_form: "Base Word Morphology",

    // Additional Settings Translations
    settings_additional_assets: "Additional Offline Assets",
    settings_additional_assets_desc: "Add surah info and word morphology packs for a richer offline reading experience.",
    settings_word_analysis: "Quran Word Analysis",
    settings_word_analysis_desc: "Helps understand word morphology and structure when tapping Arabic words, including roots, lemmas, and forms.",
    settings_surah_info_offline: "Offline Surah Info & Asbabun Nuzul",
    settings_surah_info_offline_desc: "Provides explanations of surahs, revelation background, and core themes for offline reading.",
    settings_default_mushaf_mode: "Default Mushaf Mode",
    settings_mushaf_not_downloaded: "Not yet downloaded for offline image view",
    settings_tab_mushaf: "Mushaf",
    settings_active_reciter: "Active reciter",
    settings_mushaf_ready: "styles ready",
    theme_light_btn: "Light",
    theme_dark_btn: "Dark",
    theme_system_btn: "System"
  }
};
