    ...
    return (
        <div className="min-h-screen bg-stone-50 dark:bg-slate-900 pb-20 animate-fade-in transition-colors duration-300">
            <div className="max-w-3xl mx-auto px-3 sm:px-4 py-6 sm:py-8 space-y-4 sm:space-y-6">
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex-shrink-0 flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 rounded-full text-xs sm:text-sm font-bold transition-all duration-300 border snap-start whitespace-nowrap active:scale-[0.98] ${
                                        isActive 
                ...
                {/* CONTENT AREA */}
                <div className="bg-white dark:bg-slate-800 rounded-2xl border border-stone-200 dark:border-slate-700 shadow-sm min-h-[50vh] overflow-hidden">
                    
                    {/* --- TAB 1: TENTANG --- */}
                    {activeTab === 'about' && (
                        <div className="p-6 sm:p-8 flex flex-col items-center justify-center w-full">
                        ...
                        <div className="p-6 sm:p-8">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {featuresList.map((feat, idx) => (
                                    <div key={idx} className="flex items-start gap-4 p-4 rounded-2xl border border-stone-200 dark:border-slate-700 bg-stone-50/50 dark:bg-slate-700/50 hover:border-quran-gold/30 dark:hover:border-quran-gold/30 hover:bg-stone-50 dark:hover:bg-slate-700 transition-all">
                                        <div className="w-10 h-10 rounded-xl bg-quran-gold/10 flex items-center justify-center text-quran-dark dark:text-quran-gold shrink-0 border border-quran-gold/20">
