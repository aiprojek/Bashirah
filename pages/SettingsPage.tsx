                ...
                <div className="flex items-center justify-between border-t border-stone-100 dark:border-slate-700 pt-5">
                 ...
                 <div className="border-t border-stone-100 dark:border-slate-700 pt-5">
                     <div className="flex justify-between items-start">
                        <div>
                            <h2 className="text-base font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2"><Palette className="w-4 h-4 text-quran-gold" /> {t('settings_tajweed')}</h2>
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-xs">
                                {isTajweedDownloaded 
                                    ? t('settings_tajweed_downloaded')
                                    : t('settings_tajweed_desc')}
                            </p>
                        </div>
                ...
                {activeSection === 'audio' && (
                    <div className="p-5 bg-stone-50/30 dark:bg-slate-900/30 space-y-6">
                        ...
                        >
                            ...
                            return (
                                <div key={surah.id} className="p-3 flex items-center justify-between hover:bg-stone-50 dark:hover:bg-slate-700 relative">
                                    ...
                                    <div className="flex items-center gap-2 relative z-10">
                                        {isThisSurahDownloading ? 
                                            ...
                                            : isDownloaded ? 
                                                <button onClick={() => handleDeleteSurahAudio(surah.id)} className="p-2 text-green-600 hover:text-red-500"><Trash2 className="w-4 h-4" /></button> 
                                            : 
                                                <button onClick={() => handleDownloadSurahAudio(surah)} disabled={isDownloadingAudio} className="p-2 text-gray-400 hover:text-quran-gold"><Download className="w-4 h-4" /></button>
                                        }
                                    </div>
                                </div>
                            ); 
