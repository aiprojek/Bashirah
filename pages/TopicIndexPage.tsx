        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in min-h-screen">
            ...
            <div className="text-center mb-8">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 mt-3">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300 border border-emerald-200/60 dark:border-emerald-800/60">
                ...
                <div className="pt-2 border-t border-stone-100 dark:border-slate-700/80">
                    <div className="grid grid-cols-2 p-1 bg-stone-100 dark:bg-slate-900 rounded-xl gap-1 sm:max-w-md sm:mx-auto">
                        ...
                        >
                            ...
                            <span className="px-1.5 py-0.5 rounded-full text-[10px] bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 font-bold shrink-0">
                                ...
                                {filteredAyahTopics.slice(0, visibleCount).map((topic) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className="bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-5 shadow-xs border border-stone-200/80 dark:border-slate-700 hover:border-emerald-500/50 dark:hover:border-emerald-500/50 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
                                        >
                                            <div className="mb-3">
                                                {/* Header with pill and Arabic */}
                                                <div className="flex items-center justify-between gap-2 mb-3">
                                                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 border border-emerald-200/60 dark:border-emerald-800/60">
                                                        <Hash className="w-3 h-3 text-emerald-500" />
                                                        <span>{topic.ayahs.length} {t('topics_verses_count')}</span>
                                                    </span>
                                                    {topic.arabic && (
                                                        <span className="font-arabic text-sm font-bold text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                                                            {topic.arabic}
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                {/* Judul */}
                                                <h3 className="text-base font-bold text-gray-800 dark:text-gray-100 group-hover:text-emerald-700 dark:group-hover:text-emerald-300 transition-colors font-serif mb-1.5 line-clamp-1">
                                                    {localizedName}
                                                </h3>
                                            ...
                                            {/* Action Link Footer */}
                                            <div className="pt-2.5 border-t border-stone-100 dark:border-slate-700/80 flex items-center justify-between text-xs font-semibold text-emerald-700 dark:text-emerald-400">
                            ...
                            {visibleCount < filteredAyahTopics.length && (
                                <div className="text-center pt-4">
                                    <button
                                        ...
                                        className="px-6 py-3 rounded-xl bg-white dark:bg-slate-800 border border-stone-200 dark:border-slate-700 text-gray-700 dark:text-gray-200 font-semibold text-sm hover:bg-stone-50 dark:hover:bg-slate-700 hover:border-emerald-500/50 shadow-xs transition-all inline-flex items-center gap-2"
                                    >
            ...
            {selectedAyahTopic && (
                <UnifiedModal
                    ...
                    badgeColorClass="bg-emerald-100/80 text-emerald-800 dark:bg-emerald-950/60 dark:text-emerald-300 border-emerald-300 dark:border-emerald-700"
                    title={
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-emerald-50 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 flex items-center justify-center font-bold text-sm">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    {selectedAyahTopic.arabic && (
                                        <span className="font-arabic text-base font-bold text-emerald-700 dark:text-emerald-400">
                                            {selectedAyahTopic.arabic}
                                        </span>
                                    )}
                                </div>
                ...
                >
                    <div className="space-y-4">
                        ...
                        {getLocalizedTopicDescription(selectedAyahTopic, language) && (
                            <div className="p-3.5 rounded-xl bg-emerald-50/70 dark:bg-emerald-950/20 border border-emerald-200/50 dark:border-emerald-800/40 text-xs sm:text-sm text-gray-700 dark:text-gray-200 leading-relaxed">
                                {getLocalizedTopicDescription(selectedAyahTopic, language)}
                            </div>
                        )}
                        ...
                        <div className="flex items-center justify-between gap-2">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full pl-8 pr-7 py-1.5 rounded-lg bg-stone-100 dark:bg-slate-900 border border-stone-200 dark:border-slate-700 text-xs text-gray-800 dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                                />
                                {modalAyahFilter && (
                                    <button
                            ...
                            {filteredModalAyahs.length === 0 ? (
                                ...
                                filteredModalAyahs.map((ref) => (
                                    <button
                                        ...
                                        className="w-full bg-white dark:bg-slate-800 p-3 rounded-xl border border-stone-200/80 dark:border-slate-700 shadow-2xs hover:border-emerald-500 hover:shadow-xs transition-all flex items-center justify-between group text-left"
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="w-7 h-7 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-400 font-bold text-xs flex items-center justify-center border border-emerald-200/60 dark:border-emerald-800/60 shrink-0">
                                                {ref.id}
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-gray-800 dark:text-gray-100 text-sm font-serif group-hover:text-emerald-700 dark:group-hover:text-emerald-300 transition-colors">
                                        ...
                                        <div className="w-7 h-7 rounded-full flex items-center justify-center text-gray-300 dark:text-gray-500 group-hover:text-emerald-600 group-hover:translate-x-0.5 transition-all">
                        ...
                        >
                            {copiedCurated ? (
                                <>
                                    ...
                                    <span className="text-emerald-600 hidden sm:inline">{language === 'en' ? 'Copied' : 'Tersalin'}</span>
                                </>
                            ) : (
                                <>
