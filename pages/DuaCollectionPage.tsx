        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in pb-24">
            ...
            <div className="space-y-6">
                {filteredDuas.map((dua) => {
                    ...
                    return (
                        <div key={dua.id} className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-slate-700 hover:shadow-md transition-all relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="flex gap-1">
                                        <button 
                                            ...
                                            className={`p-2 rounded-full transition-colors ${isBookmarked ? 'text-quran-gold bg-quran-gold/10' : 'text-gray-300 hover:bg-stone-100 dark:hover:bg-slate-700'}`}
                                            title="Bookmark"
                                        >
                                ...
                                <div className="text-right mb-6" dir="rtl">
                                    <p className="font-arabic text-3xl leading-[2.5] text-quran-dark dark:text-white">
                                        {dua.arabic}
                                    </p>
                                </div>
